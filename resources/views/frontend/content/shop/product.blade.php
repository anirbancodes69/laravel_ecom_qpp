                ...
                <div class="col-md-6">
                    <div class="tf-product-media-wrap sticky-top">
                        <div class="thumbs-slider thumbs-default">
                            <div dir="ltr" class="swiper tf-product-media-thumbs tf-product-media-thumbs-default"
                        ...
                        <div class="tf-product-info-list other-image-zoom">
                            ...
                            <div class="tf-product-info-variant-picker">
                                <div class="variant-picker-item">
                                    <div class="variant-picker-label">
                                        Color: <span
                                            class="fw-6 variant-picker-label-value value-currentColor">White</span>
                                    </div>
                                    <div class="variant-picker-values">
                                        <input id="values-white" type="radio" name="color1" checked>
                                        <label class="hover-tooltip radius-60 color-btn active" data-color="white"
                                            for="values-white" data-value="White">
                                            <span class="btn-checkbox bg_white"></span>
                                            <span class="tooltip">White</span>
                                        </label>
                                        <input id="values-pink" type="radio" name="color1">
                                        <label class=" hover-tooltip radius-60 color-btn" data-color="pink"
                                            for="values-pink" data-value="Pink">
                                            <span class="btn-checkbox bg_pink"></span>
                                            <span class="tooltip">Pink</span>
                                        </label>
                                        <input id="values-black" type="radio" name="color1">
                                        <label class="hover-tooltip radius-60 color-btn" data-color="black"
                                            for="values-black" data-value="Black">
                            ...
                            <div class="tf-product-info-extra-link">
                                <a href="#compare_color" data-bs-toggle="modal" class="tf-product-extra-icon">
                                    <div class="icon">
                                        <img src="{{ asset('frontend/assets') }}/images/item/compare.svg" alt="">
                                    </div>
            ...
            <div class="tf-height-observer w-100 d-flex align-items-center">
                <div class="tf-sticky-atc-product d-flex align-items-center">
                    <div class="tf-sticky-atc-img">
                        <img class="lazyloaded" data-src="{{ asset('frontend/assets') }}/images/shop/products/p-d1.png"
                            alt="" src="{{ asset('frontend/assets') }}/images/shop/products/p-d1.png">
                    </div>
                                ...
                                <ul class="list-color-product">
                                    ...
                                    <li class="list-color-item color-swatch">
                                        ...
                                        <img class="lazyload"
                                            ...
                                            src="{{ asset('frontend/assets') }}/images/products/blue.jpg"
                                            alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
...
<section class="flat-spacing-4 pt_0">
    <div class="container">
        ...
        <div class="hover-sw-nav hover-sw-2">
            <div dir="ltr" class="swiper tf-sw-recent wrap-sw-over" data-preview="4" data-tablet="3" data-mobile="2"
