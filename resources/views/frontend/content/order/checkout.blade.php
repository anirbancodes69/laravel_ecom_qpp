                        ...
                        <ul class="wrap-checkout-product">
                            <li class="checkout-product-item">
                                <figure class="img-product">
                                    <img src="{{ asset('frontend/assets') }}/images/products/brown.jpg" alt="product">
                            ...
                            <li class="checkout-product-item">
                                <figure class="img-product">
                                    <img src="{{ asset('frontend/assets') }}/images/products/kid-12.jpg" alt="product">
                                    <span class="quantity">1</span>
                                </figure>
                                <div class="content">
                                    <div class="info">
                            ...
                            <li class="checkout-product-item">
                                <figure class="img-product">
                                    <img src="{{ asset('frontend/assets') }}/images/products/beige-2.jpg" alt="product">
                                    <span class="quantity">1</span>
                                </figure>
                                <div class="content">
                                    <div class="info">
                            ...
                            <li class="checkout-product-item">
                                <figure class="img-product">
                                    <img src="{{ asset('frontend/assets') }}/images/products/orange-1.jpg"
                                        alt="product">
