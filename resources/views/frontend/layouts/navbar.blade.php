                    ...
                    <ul class="box-nav-ul d-flex align-items-center justify-content-center gap-30">
                        ...
                        <li class="menu-item position-relative">
                            ...
                            <div class="sub-menu submenu-default">
                                <ul class="menu-list">
                                    <li><a href="blog-grid.html" class="menu-link-text link text_black-2">Men</a></li>
                                    <li><a href="blog-sidebar-left.html"
                                            class="menu-link-text link text_black-2">Women</a></li>
                                    <li><a href="blog-sidebar-right.html"
                                            class="menu-link-text link text_black-2">Kids</a></li>
                                    <li><a href="blog-list.html" class="menu-link-text link text_black-2">Unisex</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
